/**
 * Background service worker for Costcoholic extension
 * Handles storage, messaging, and context menu
 */
...
/**
 * Persist receipts data to chrome.storage.local
 */
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  ...
  if (message.type === "getReceipts") {
    // Get from storage with fallback to cache
...
/**
 * Open Order Status page based on user preference
 */
